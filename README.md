...
If anyone's wondering, and cares, I am currently engaged in construction of [the Guillmet Scheme](https://gist.github.com/Chubek/7221f9717aa92112fc50a758b76decc9); a subset (or hopefully, one day, superset!) of the Scheme S-Expression LISP-like language (by Steele and Sussman, you know, Scheme!) meant to be translated down to x86-64 Assembly (which you can view some code of mine in below). I will not use a ready-made IL like QBE or LLVM. I will use supercombinators, and other methods of optimizing an FP-like language like Scheme. Did you know Muchnick, or the compiler book fame, did a paper on LISP dataflow?
...
Not to be uncouth, but I offer my services to any professors in any university.
